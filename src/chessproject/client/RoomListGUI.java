...
public class RoomListGUI extends javax.swing.JFrame implements WindowListener {
    ...
    private final AutoUpdateHandling autoUpdate;

    /**
     * Creates new form RoomListGUI
     */
    public RoomListGUI() throws IOException, ClassNotFoundException {
        initComponents();
        roomHandling = new ClientRoomHandling(ServerInformation.getServerHost(), ServerInformation.getServerPort());
        this.addWindowListener(this);
        autoUpdate = new AutoUpdateHandling(this);
        autoUpdate.start();
        refreshData();
    }
    ...
    private void joinButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_joinButtonActionPerformed
        ...
        try {
            ...
            String roomID = roomTable.getModel().getValueAt(index, 0) + "";
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(RoomListGUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    public void refreshData() throws IOException, ClassNotFoundException {
        ...
        try {
            ArrayList<RoomInformations> rooms = roomHandling.roomRefresh();//roomHandling will handle getting the room list from the server
            updateRoomTable(rooms);//Call this method to display the room list on the room table.
        } catch (IOException | ClassNotFoundException ex) {
    ...
    private void updateRoomTable(ArrayList<RoomInformations> rooms) {
    ...
    public void exitRoom(String message) throws IOException {
